...
import { NETLIFYDEVERR, NETLIFYDEVLOG, NETLIFYDEVWARN, nonNullable, chalk, log, warn, isNodeError, } from '../../utils/command-helpers.js';
...
export class EdgeFunctionsRegistry {
     ...
     */
    matchURLPath(urlPath, method, headers) {
        const functionNames = [];
        const routeIndexes = [];
