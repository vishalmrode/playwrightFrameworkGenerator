...
interface CredenzaActionProps extends Omit<ButtonProps, 'children'> {
  children: React.ReactNode
}
...
const CredenzaAction = React.forwardRef<HTMLButtonElement, CredenzaActionProps>(
...
CredenzaAction.displayName = "CredenzaAction";
