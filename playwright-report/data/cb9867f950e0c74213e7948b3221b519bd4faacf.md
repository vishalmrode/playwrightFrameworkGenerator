...
- Name: Testing Capabilities Component >> can toggle API testing capability
- Location: D:\Projects\playwrightFrameworkGenerator\tests\testing-capabilities.test.ts:57:3
...
Locator: getByTestId('api-testing-checkbox')
Expected: checked
...
Call log:
  ...
  - waiting for getByTestId('api-testing-checkbox')
    ...
    at D:\Projects\playwrightFrameworkGenerator\tests\testing-capabilities.test.ts:61:31
```
