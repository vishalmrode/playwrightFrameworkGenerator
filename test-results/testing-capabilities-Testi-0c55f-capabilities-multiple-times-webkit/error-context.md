...
- Name: Testing Capabilities Component >> maintains state when toggling capabilities multiple times
- Location: D:\Projects\playwrightFrameworkGenerator\tests\testing-capabilities.test.ts:116:3
...
Call log:
  - waiting for getByTestId('ui-testing-checkbox')
    ...
    at D:\Projects\playwrightFrameworkGenerator\tests\testing-capabilities.test.ts:121:22
```
