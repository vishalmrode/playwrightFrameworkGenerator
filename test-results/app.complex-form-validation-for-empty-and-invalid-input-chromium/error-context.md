...
- Name: form validation for empty and invalid input
- Location: D:\Projects\playwrightFrameworkGenerator\tests\app.complex.test.ts:54:1
...
Locator: getByTestId('project-name-error')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByTestId('project-name-error')

    at D:\Projects\playwrightFrameworkGenerator\tests\app.complex.test.ts:65:56
```
