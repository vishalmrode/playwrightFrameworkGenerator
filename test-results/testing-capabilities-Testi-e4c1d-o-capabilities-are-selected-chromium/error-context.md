...
- Name: Testing Capabilities Component >> shows validation warning when no capabilities are selected
- Location: D:\Projects\playwrightFrameworkGenerator\tests\testing-capabilities.test.ts:79:3
...
Call log:
  - waiting for getByTestId('ui-testing-checkbox')
    ...
    at D:\Projects\playwrightFrameworkGenerator\tests\testing-capabilities.test.ts:84:22
```
