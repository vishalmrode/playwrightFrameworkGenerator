...
- Name: Testing Capabilities Component >> can toggle UI testing capability
- Location: D:\Projects\playwrightFrameworkGenerator\tests\testing-capabilities.test.ts:35:3
...
Call log:
  ...
  - waiting for getByTestId('ui-testing-checkbox')
    ...
    at D:\Projects\playwrightFrameworkGenerator\tests\testing-capabilities.test.ts:39:30
```
