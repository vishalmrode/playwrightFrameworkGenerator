...
Call log:
  ...
  - waiting for getByTestId('project-name-input')
    6 × locator resolved to <input type="text" id="project-name" name="project-name" data-testid="project-name-input" placeholder="Enter your project name" class="w-full border rounded px-3 py-2 text-base"/>
      - unexpected value ""
