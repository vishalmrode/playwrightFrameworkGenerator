...
- Name: Testing Capabilities Component >> checkboxes are properly labeled and accessible
- Location: D:\Projects\playwrightFrameworkGenerator\tests\testing-capabilities.test.ts:137:3
...
Locator: getByTestId('ui-testing-label')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByTestId('ui-testing-label')

    at D:\Projects\playwrightFrameworkGenerator\tests\testing-capabilities.test.ts:142:27
```
