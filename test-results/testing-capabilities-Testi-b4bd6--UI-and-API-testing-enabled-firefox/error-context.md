...
- Name: Testing Capabilities Component >> renders with default state - both UI and API testing enabled
- Location: D:\Projects\playwrightFrameworkGenerator\tests\testing-capabilities.test.ts:8:3
...
Locator: getByTestId('ui-testing-checkbox')
Expected: checked
Received: <element(s) not found>
Call log:
  - expect.toBeChecked with timeout 5000ms
  - waiting for getByTestId('ui-testing-checkbox')

    at D:\Projects\playwrightFrameworkGenerator\tests\testing-capabilities.test.ts:16:59
```
